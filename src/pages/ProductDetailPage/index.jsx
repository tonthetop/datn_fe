...
function ProductDetailPage() {
  ...
  const [relativeItems, setRelativeItems] = useState([]);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setRelativeItems(result.products);
        setProduct(product);
        setSubInfo({
  ...
  console.log({ product, relativeItems });
    ...
    <>
      <div className="row product-detail-main">
        ...
        <div className="col-xs-12 col-md-6 px-4">
          <div className="product-detail-top">
            <div className="product-title p-title">
              <h3 style={{ fontWeight: "normal" }}>{product.name}</h3>
            </div>
          ...
          <div className="product-detail-mid py-2 d-flex justify-content-between flex-column gap-2">
            ...
            <span>
              ...
              <span style={{ color: "red", fontWeight: "bold" }}>
                {" "}
                {subInfo.amountOfSize === 0
                  ? "Hết hàng"
                  : subInfo.amountOfSize + " sản phẩm"}
              </span>
            </span>
          ...
          <Form.Group className="my-2">
            ...
            <InputNumber
              min={0}
              max={subInfo.amountOfSize}
              value={subInfo.amount}
              onChange={handleChangeSubInfoAmount}
              style={{ width: "70px" }}
            ></InputNumber>
          </Form.Group>
        ...
        <Tabs defaultActiveKey="3" size="large" type="line" className="">
          ...
          >
            <div className="tab-danhgia">
              ...
              <ButtonAnt className="d-block" type="primary">
                Gửi đánh giả của bạn
              </ButtonAnt>
            </div>
          </TabPane>
        </Tabs>
      ...
      <div className="row products-neighbor mb-3">
        <h1 className="text-uppercase text-center ">
          <span className="title-banner border-dark ">Sản phẩm liên quan</span>
        </h1>
        <ThumbGallery productList={relativeItems}></ThumbGallery>
      </div>
    </>
  );
}
