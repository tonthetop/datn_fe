...
export const LikeButton = () => {
    ...
    const url=`https://www.facebook.com/plugins/like.php?href=${href}&width=174&layout=button_count&action=like&size=large&share=true&height=28&appId=998182394159488`
    return (
