        ...
        <div className="col-xs-12 col-md-7">
          <div className="row mb-4">
            ...
            <div className="col-10">
              ...
              <p className="">
                Vui lòng kiểm tra đơn hàng thông qua&nbsp;
                <u className="fw-bold fs-6">{order.accountId.email}</u>
                &nbsp; hoặc SĐT của bạn &nbsp;
                <u className="fw-bold fs-6">{order.accountId.phone}</u>
                <br />
              </p>
            </div>
          </div>
          ...
          <div className="row text-center">
            <Link to="/" className="">
              <Button
                className="rounded-pill text-uppercase my-3 py-2"
